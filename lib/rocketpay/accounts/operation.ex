defmodule Rocketpay.Accounts.Operation do
  ...
  def call(%{"id" => id, "value" => value}, operation) do
    operation_name = accont_operation_name(operation)
      Multi.new()
  ...
  defp handle_cast({:ok, value},balance,:withdrawl), do: Decimal.sub(balance,value)
  ...
  defp accont_operation_name(operation), do: "account_#{Atom.to_string(operation)}" |> String.to_atom()
